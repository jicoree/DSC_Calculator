...
DCMimage = pydicom.read_file('F:/ETC/DSC_Calculator/DSC_Calculator/test/Image.dcm').pixel_array

annotation = cv2.imread('F:/ETC/DSC_Calculator/DSC_Calculator/test/Annotation.png', cv2.IMREAD_GRAYSCALE)
prediction = cv2.imread('F:/ETC/DSC_Calculator/DSC_Calculator/test/Prediction_0.5.png', cv2.IMREAD_GRAYSCALE)
